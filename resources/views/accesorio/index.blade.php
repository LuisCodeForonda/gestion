<x-app-layout>
    ...
    <div class="container mx-auto">
        <div class="flex justify-between items-center">
            @can('dahsboard.accesorio.create')
            <a href="{{ route('accesorio.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Nuevo</a>
            @endcan
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex gap-4">
                            @can('dahsboard.accesorio.edit')
                            <a href="{{ route('accesorio.edit', ['accesorio'=>$accesorio->id] ) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                            @endcan
                            @can('dahsboard.accesorio.destroy')
